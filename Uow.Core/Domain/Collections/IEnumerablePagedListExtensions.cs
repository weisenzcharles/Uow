...
namespace Uow.Core.Domain.Collections
{
    ...
    public static class IEnumerablePagedListExtensions
    {
        ...
        /// <param name="totalCount">The source to total count.</param>
        /// <returns>An instance of the inherited from <see cref="IPagedList{T}"/> interface.</returns>
        public static IPagedList<T> ToPagedList<T>(this IEnumerable<T> source, int pageIndex, int pageSize, int totalCount) => new PagedList<T>(source, pageIndex, pageSize, totalCount);
